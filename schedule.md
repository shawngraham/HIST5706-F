...
## Sept 10. Meeting 1: Getting Started

**To install:**

[Plainva](https://plainva.com/) is a note writing and management overlay for a folder of plain-text files. I want you to keep your notes for this class (your thoughts, your observations, your scratch pad as you fight with things) as plain text files. Not word. Not one note. You might have a nice system set up already, but for my pedagogical purposes: plain text files using the .md file extension. Sublime Text, Notepad++, Obsidian, or Tangent are other possibilities. The advantage of Plainva is that it comes with some excellent features for making sense of your notes. _And it is harder to kill plain text through neglect_ [see Brett, part 5 of his essay](https://www.adamdjbrett.com/blog/dh-part-5-preserving-digital-humanities-projects/)
...
## Sept 17: Meeting 2: Digital History in the Wild
...
## Oct 1 Meeting 3. Quick Static Websites 
...
We'll build a website using [Pelican](https://getpelican.com/#quickstart), which is a python package that will read a folder of text files (in the markdown format), pass them through a template, and spit out the necessary html files that make a website. We'll then put these files online using Github Pages. (See my notes on using Obsidian - or other noteaking app using wikilinks eg Pelican - to write the markdown [here](../posts/pelicans.html)). 

---


## Oct. 8 Meeting 4. Networks
...
## Oct 15 Meeting 5. Topic Models and Text Analysis
...
## Oct 22 Meeting 6. examining images at scale
...
## Oct Nov 5 Meeting 7. Images & Handwriting
...
+ Scheinfeldt, Tom. 2026. Handwriting Recognition Roundup. https://foundhistory.org/handwriting-recognition-roundup/

**To do**

_This one is dated, I'll find something more recent, stay tuned_
...
## Nov 12 Meeting 8. Open Research
...
+ _something else TBD_ 

---

## Nov 19 Meeting 9. Mallory's papers: scraping & apis
...
## Nov 26 Meeting 10: LLMS & Associated Technologies
...
+ Graham, Shawn. [_Practical Necromancy for Beginners_](https://thedigitalpress.org/practical-necromancy-for-beginners/) part 1.


**To do**

This uses a very small language model, from 4 years ago when these things were small and mostly autocomplete-ish. Nowadays, there is a lot of rigging on top of monstrous obscene amounts of data. But this is helpful because it shows you what's going on behind the curtain of all the subsquent technology stack:
...
## Dec 3 Meeting 11. Mallory's papers: LLMs for NLP
...
## Dec 10 Meeting 12. Wrapping it all up
